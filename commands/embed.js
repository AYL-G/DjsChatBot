...
//Syntax: {prefix}embed <title> <color> (hex code or a basic color in all caps) <description>
...
module.exports = {
    ...
    async execute(client, message, cmd, args, Discord){
        ...
        // args.slice(2).join(" ") means we're taking all the arguments including and after the second argument. An argument is just a word or number.
        ...
        // ! means no, so if there's no title, return and send the error embed
